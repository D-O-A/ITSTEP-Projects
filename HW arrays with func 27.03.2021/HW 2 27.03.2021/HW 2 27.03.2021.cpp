...
{
	cout << "Ћень все выводить, алгоритмы работают, поверьте ;)" << endl;
}
...
int main()
{
	...
	//Ќаписать функции, определ€ющие сумму/количество:
	//Х	положительных элементов массива;
	//Х	отрицательных элементов массива;
	//Х	ненулевых элементов массива;
	//Х	четных элементов массива;
	//Х	нечетных элементов массива;
	//Х	элементов массива, кратных 3, 5, 7;
	//Х	элементов массива, кратных 3, но не кратных 5;
	//Х	элементов массива, значение которых больше 1 и меньше 5.
